...
You can download my prebuilt files from the [releases](https://github.com/shiranzby/WindowTabs/releases) page. You can also compile the `exe` file as below.

> This fork additionally ships a **complete Simplified Chinese (`zh-CN`) localization**.
> See [README.md](README.md) for details (Chinese).
...
- Clone
    ...
    ```
    git clone https://github.com/shiranzby/WindowTabs
    ```
